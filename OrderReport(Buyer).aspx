<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderReport(Buyer).aspx.cs" Inherits="FinalYearProject.OrderReport_Buyer_" %>
...
<%--             <asp:RequiredFieldValidator ID="rfvtodate" ControlToValidate="txttoinvoicedate" ValidationGroup="invoicereporting" SetFocusOnError="true" EnableClientScript="true" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>--%>
         ...
         <label style="font-size:19px;margin-left:20px;margin-right:50px">LSP* <br> <asp:DropDownList ID="dropdownseller"  Height="30px"  Width="160px" runat="server" CssClass="form-control" AutoPostBack="true" ></asp:DropDownList></label>
            <asp:RequiredFieldValidator ID="rfvseller" ControlToValidate="dropdownseller" ValidationGroup="invoicereporting" SetFocusOnError="true" EnableClientScript="true" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
