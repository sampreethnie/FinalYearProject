...
<asp:TextBox ID="TextBox2" runat="server" onkeyup="ForeignCurrencyCalculation();"  style="width:270px"/>
    ...
    <tr>
        ...
        <tr>
            ...
            <tr>
                <td>
                    <asp:Button ID="Button25" runat="server" CommandName="Add" style="width:70px; margin-right:50px;margin-left:50px;height:40px" Text="Add" OnClick="btnChargeAdd_Click" />
                </td>
                <td>
