    ...
    public partial class InvoiceReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                concompany.Open();
                SqlCommand comcompany = new SqlCommand("select distinct TM_INVOICE_Customer from TM_INVOICE", concompany);
                SqlDataAdapter dacompany = new SqlDataAdapter(comcompany);
                DataSet dscompany = new DataSet();
                dacompany.Fill(dscompany);

                dropdowncustomer.DataTextField = dscompany.Tables[0].Columns["TM_INVOICE_Customer"].ToString();
        ...
        private void BindGridView()
        {
            ...
            if (chkall.Checked)
            {
                SqlCommand cmd = new SqlCommand("select TM_INVOICE.TM_INVOICE_Slno,TM_INVOICE.TM_INVOICE_No,TM_INVOICE.TM_INVOICE_Date,TM_INVOICE.TM_INVOICE_Customer,TM_INVOICE.TM_INVOICE_RFQNumber,ShipmentDetailsSeller.hawb,ShipmentDetailsSeller.delivery,TM_INVOICE.TM_INVOICE_Status from TM_INVOICE inner join ShipmentDetailsSeller on TM_INVOICE.TM_INVOICE_RFQNumber = ShipmentDetailsSeller.ShipmentRFQ_Number where TM_INVOICE_Date between @fromdate and @todate and  TM_INVOICE.TM_INVOICE_Customer= @customerinvoice and TM_INVOICE_Status = 'Y' or TM_INVOICE_Status = 'P' or TM_INVOICE_Status = 'N';select SUM(TD_INVOICE_TAXAMOUNT), SUM(TD_INVOICE_TOTALAMOUNT) from TD_INVOICE inner join TM_INVOICE on TD_INVOICE.TD_INVOICE_TMSLNO = TM_INVOICE.TM_INVOICE_No   group by TM_INVOICE.TM_INVOICE_No;", con);
                cmd.Parameters.AddWithValue("@customerinvoice", dropdowncustomer.SelectedItem.Text);
            ...
            {
                SqlCommand cmd = new SqlCommand("select TM_INVOICE.TM_INVOICE_Slno,TM_INVOICE.TM_INVOICE_No,TM_INVOICE.TM_INVOICE_Date,TM_INVOICE.TM_INVOICE_Customer,TM_INVOICE.TM_INVOICE_RFQNumber,ShipmentDetailsSeller.hawb,ShipmentDetailsSeller.delivery,TM_INVOICE.TM_INVOICE_Status from TM_INVOICE inner join ShipmentDetailsSeller on TM_INVOICE.TM_INVOICE_RFQNumber = ShipmentDetailsSeller.ShipmentRFQ_Number where TM_INVOICE_Date between @fromdate and @todate and  TM_INVOICE.TM_INVOICE_Customer= @customerinvoice and TM_INVOICE_Status = 'Y';select SUM(TD_INVOICE_TAXAMOUNT), SUM(TD_INVOICE_TOTALAMOUNT) from TD_INVOICE inner join TM_INVOICE on TD_INVOICE.TD_INVOICE_TMSLNO = TM_INVOICE.TM_INVOICE_No   group by TM_INVOICE.TM_INVOICE_No;", con);
                cmd.Parameters.AddWithValue("@customerinvoice", dropdowncustomer.SelectedItem.Text);
                cmd.Parameters.AddWithValue("@fromdate", Convert.ToDateTime(txtfrominvoicedate.Text));
                cmd.Parameters.AddWithValue("@todate", Convert.ToDateTime(txttoinvoicedate.Text));
                SqlDataAdapter da = new SqlDataAdapter(cmd);
            ...
            {
                SqlCommand cmd = new SqlCommand("select TM_INVOICE.TM_INVOICE_Slno,TM_INVOICE.TM_INVOICE_No,TM_INVOICE.TM_INVOICE_Date,TM_INVOICE.TM_INVOICE_Customer,TM_INVOICE.TM_INVOICE_RFQNumber,ShipmentDetailsSeller.hawb,ShipmentDetailsSeller.delivery,TM_INVOICE.TM_INVOICE_Status from TM_INVOICE inner join ShipmentDetailsSeller on TM_INVOICE.TM_INVOICE_RFQNumber = ShipmentDetailsSeller.ShipmentRFQ_Number where TM_INVOICE_Date between @fromdate and @todate and  TM_INVOICE.TM_INVOICE_Customer= @customerinvoice and TM_INVOICE_Status = 'N';select SUM(TD_INVOICE_TAXAMOUNT), SUM(TD_INVOICE_TOTALAMOUNT) from TD_INVOICE inner join TM_INVOICE on TD_INVOICE.TD_INVOICE_TMSLNO = TM_INVOICE.TM_INVOICE_No   group by TM_INVOICE.TM_INVOICE_No;", con);
                cmd.Parameters.AddWithValue("@customerinvoice", dropdowncustomer.SelectedItem.Text);
                cmd.Parameters.AddWithValue("@fromdate", Convert.ToDateTime(txtfrominvoicedate.Text));
                cmd.Parameters.AddWithValue("@todate", Convert.ToDateTime(txttoinvoicedate.Text));
                SqlDataAdapter da = new SqlDataAdapter(cmd);
            ...
            {
                SqlCommand cmd = new SqlCommand("select TM_INVOICE.TM_INVOICE_Slno,TM_INVOICE.TM_INVOICE_No,TM_INVOICE.TM_INVOICE_Date,TM_INVOICE.TM_INVOICE_Customer,TM_INVOICE.TM_INVOICE_RFQNumber,ShipmentDetailsSeller.hawb,ShipmentDetailsSeller.delivery,TM_INVOICE.TM_INVOICE_Status from TM_INVOICE inner join ShipmentDetailsSeller on TM_INVOICE.TM_INVOICE_RFQNumber = ShipmentDetailsSeller.ShipmentRFQ_Number where TM_INVOICE_Date between @fromdate and @todate and  TM_INVOICE.TM_INVOICE_Customer= @customerinvoice and TM_INVOICE_Status = 'P';select SUM(TD_INVOICE_TAXAMOUNT), SUM(TD_INVOICE_TOTALAMOUNT) from TD_INVOICE inner join TM_INVOICE on TD_INVOICE.TD_INVOICE_TMSLNO = TM_INVOICE.TM_INVOICE_No   group by TM_INVOICE.TM_INVOICE_No;", con);
                cmd.Parameters.AddWithValue("@customerinvoice", dropdowncustomer.SelectedItem.Text);
                cmd.Parameters.AddWithValue("@fromdate", Convert.ToDateTime(txtfrominvoicedate.Text));
                cmd.Parameters.AddWithValue("@todate", Convert.ToDateTime(txttoinvoicedate.Text));
                SqlDataAdapter da = new SqlDataAdapter(cmd);
