<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Orders(Buyer).aspx.cs" Inherits="FinalYearProject.Orders_Buyer_" %>
...
<AlternatingRowStyle BackColor="White" />
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ORD_Date" HeaderText="Order Date" DataFormatString="{0:dd/M/yyyy}" />
                         <asp:BoundField DataField="ORD_SQ_Company" HeaderText="SellerCompanyName" />
                        ...
                        <asp:BoundField DataField="ORD_SellerCurrency" HeaderText="Seller Currency" />
                        <asp:BoundField DataField="ORD_SQ_Slno" HeaderText="SQSlno" Visible="false"   />
                       ...
                       <asp:BoundField DataField="ORD_SQ_RFQ_CreationDate" HeaderText="CreationDate" />
                        ...
                        <asp:BoundField DataField="ORD_SQ_BuyerCurrency" HeaderText="Buyer Currency" Visible="false" />
                        <asp:BoundField DataField="ORD_SQ_RFQ_Company" HeaderText="Buyer Company" Visible="false" />
