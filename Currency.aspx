<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Currency.aspx.cs"  Inherits="FinalYearProject.Currency" %>
...
<body>
  ...
  <ul class="dropdown-menu" role="menu">
    ...
    <p class="navbar-text" style="font-size:21px">Currency</p>
...
<span class="input-group-addon nbrd" style="padding:0px 4px">
 ...
 <span class="input-group-addon nbrd" style="padding:0px 4px">
        ...
        <asp:GridView ID="gvCurrency" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="table-ui table-hover" DataKeyNames="M_Currency_code" EmptyDataText="No record found!"
            ...
            <Columns>
                <asp:BoundField HeaderText="ID" DataField="M_Currency_Code" Visible="false" />
                 <asp:BoundField HeaderText="Name" DataField="M_Currency_Name" />
                 <asp:BoundField HeaderText="ShortName" DataField="M_Currency_Sname" />
...
<EmptyDataRowStyle CssClass="gvEmpty"></EmptyDataRowStyle>
        ...
        <div id="pn1AddPopup" runat="server" style="width:500px; height:220px; background-color:#FFFFFF; border:3px solid#0DA9D0;border-radius:12px;padding:0">
             <div id="popupheader" class="popupHeader" style="background-color:orange;height:30px;color:white;line-height:30px;text-align:left;font-weight:bold;border-top-left-radius:6px;border-top-right-radius:6px">
                 <asp:Label ID="lblHeader" runat="server" Text="Add Currency" style="font-size:26px;padding:10px;font-style:inherit;font-family:Tahoma" />
                 <span style="float:right">
                    <img id="imgClose" src="/images/close3.png" alt="close1" title="Close1" />
                 </span>
             </div>
        <div>
            <asp:HiddenField ID="currencyid" runat="server" Value="0" />
            <table border="0" class="table-border" style="min-height:50px;line-height:30px;text-align:left;font-weight:normal;font-size:17px">
                <tr>
                    ...
                    <td>Name</td>
                    <td><asp:TextBox ID="txtcurrencyname" runat="server"  /> 
                        </td>
                    <td>
                      <asp:RequiredFieldValidator ID="currname" ControlToValidate="txtcurrencyname"  ValidationGroup="addpopup"  SetFocusOnError="true" EnableClientScript="true" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>     
                    </td>
                ...
                <tr>
                    <td>ShortName</td>
                    <td><asp:TextBox ID="txtcurrencyshortname" runat="server" />
                        </td>
                    <td>
                         <asp:RequiredFieldValidator ID="currsname" ControlToValidate="txtcurrencyshortname" ValidationGroup="addpopup"  SetFocusOnError="true" EnableClientScript="true" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                       </td>
            ...
            <div id="pn1EditPopup" runat="server" style="width:500px; height:220px; background-color:#FFFFFF; border:3px solid#0DA9D0;border-radius:12px;padding:0">
             <div id="popupheader1" class="popupHeader1" style="background-color:orange;height:30px;color:white;line-height:30px;text-align:left;font-weight:bold;border-top-left-radius:6px;border-top-right-radius:6px">
                 <asp:Label ID="Label2" runat="server" Text="Edit Currency" style="font-size:26px;padding:10px;font-style:inherit;font-family:Tahoma" />
                 <span style="float:right">
                    <img id="imgClose1" src="/images/close3.png" alt="close" title="Close" />
                 </span>
             </div>
        <div>
            <asp:HiddenField ID="currencyid1" runat="server" Value="0"  />
            <table border="0" class="table-border" style="min-height:50px;line-height:30px;text-align:left;font-weight:normal;font-size:17px">
                <tr>
                    <td>Name</td>
                    <td><asp:TextBox ID="txtcurrencyname1" runat="server" /></td>
                    <td> 
                        <asp:RequiredFieldValidator ID="currnameEditpopup" ControlToValidate="txtcurrencyname1" ValidationGroup="editpopup" SetFocusOnError="true" EnableClientScript="true" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>ShortName</td>
                    <td><asp:TextBox ID="txtcurrencyshortname1" runat="server" /></td>
                    <td> 
                        <asp:RequiredFieldValidator ID="currsnameEditpopup" ControlToValidate="txtcurrencyname1" ValidationGroup="editpopup" SetFocusOnError="true" EnableClientScript="true" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                <td>
        ...
        <div id="pn1ViewPopup" runat="server" style="width:550px;height:200px; background-color:#FFFFFF;border:3px solid#0DA9D0;border-radius:12px;padding:0">
            <div id="popupheader2" class="popupHeader2" style="background-color:orange;height:30px;color:white;line-height:30px;text-align:left;font-weight:bold;border-top-left-radius:6px;border-top-right-radius:6px" >
                <asp:Label ID="Label1" runat="server" Text="View Currency" style="font-size:26px;padding:10px;font-style:inherit;font-family:Tahoma" />
                <span style="float:right">
            ...
            <div>
                <asp:HiddenField ID="currencyid2" runat="server" Value="0"  />
                <table border="0" class="table-border" style="min-height:50px;line-height:30px;text-align:left;font-weight:normal;font-size:17px">
                    <tr>
                        <td>Name</td>
                        
                        <td><asp:TextBox ID="viewcurrencyname" runat="server" ReadOnly="true" /></td>
                     ...
                     <tr>
                        ...
                        <td><asp:TextBox ID="viewcurrencyshortname" runat="server" ReadOnly="true"/></td>
        ...
        <ajaxToolkit:ModalPopupExtender ID="mpeCurrency" runat="server" TargetControlID="currencyid"
            ...
            CancelControlID="imgClose" PopupDragHandleControlID="popupheader" BackgroundCssClass="modalBackground"  />
             <ajaxToolkit:ModalPopupExtender ID="mpeCurrency1" runat="server" TargetControlID="currencyid"
        ...
        <ajaxToolkit:ModalPopupExtender ID="mpeCurrency2" runat="server" TargetControlID="currencyid"
