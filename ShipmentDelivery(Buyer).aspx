    ...
    <p class="navbar-text" style="font-size:21px">Shipment Delivery(Buyer)</p>
        ...
        <div>
          ...
          <label style="font-size:19px;margin-left:20px;margin-right:50px"> Number of packages <br> <asp:TextBox ID="txtnoofpackages" Width="145px"  runat="server"></asp:TextBox> </label>
            ...
            <label style="font-size:19px;margin-left:55px;margin-right:70px"> Delivery date Seller * <br > <asp:TextBox ID="txtdeliverydate" CssClass="form-control" Width="145px" runat="server" ></asp:TextBox> </label>
             ...
             <label style="font-size:19px"> ReceivedBy Seller <br> <asp:TextBox ID="txtsellerreceivedby" Width="145px" runat="server"></asp:TextBox> </label>
            <br />
            <br />
            ...
            <label style="font-size:19px;margin-left:50px"> ReceivedBy Buyer <br> <asp:TextBox ID="txtbuyerreceivedbyname" Width="145px" runat="server"></asp:TextBox> </label>
