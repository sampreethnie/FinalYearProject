<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RateComparisonReport.aspx.cs" Inherits="FinalYearProject.RateComparisonReport" %>
...
<body>
  ...
  <ul class="dropdown-menu" role="menu">
    ...
    <p class="navbar-text" style="font-size:21px">Rate Comparison Report(Buyer)</p>
    ...
    <div>
         ...
         <label style="font-size:19px;margin-left:20px;margin-right:50px">Select RFQ Number <br> <asp:DropDownList ID="dropdownseller"  Height="30px"  Width="220px" runat="server" CssClass="form-control" AutoPostBack="true" ></asp:DropDownList></label>
            <asp:RequiredFieldValidator ID="rfvseller" ControlToValidate="dropdownseller" ValidationGroup="ratecomparison" SetFocusOnError="true" EnableClientScript="true" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
        ...
        <br />
        <br />
         <asp:GridView ID="RateComparisonGridView" runat="server"   Width="90%" Height="50px"  AllowPaging="true" DataKeyNames="SQ_Slno" AutoGenerateColumns="false" CellPadding="4" ForeColor="#333333" GridLines="None">
...
<asp:BoundField DataField="SQ_Slno" HeaderText="sqslno"  Visible="false"  ItemStyle-Width="50px" HeaderStyle-Width="400px" HeaderStyle-HorizontalAlign="Left" />

         
<asp:BoundField DataField="SQ_RFQ_Number" HeaderText="RFQ Number"   ItemStyle-Width="50px"  HeaderStyle-Width="400px" HeaderStyle-HorizontalAlign="Left" />
...
<asp:BoundField DataField="SQ_OfferPrice" HeaderText="Offer Price"  ItemStyle-Width="50px" HeaderStyle-Width="400px" HeaderStyle-HorizontalAlign="Left" />
<asp:BoundField DataField="SQ_RFQ_ExpectedPrice" HeaderText="Expected Price"   ItemStyle-Width="50px" HeaderStyle-Width="400px" HeaderStyle-HorizontalAlign="Left" />

<asp:BoundField DataField="SQ_RFQ_OriginCountry" HeaderText="Origin Country"  ItemStyle-Width="50px" HeaderStyle-Width="400px" HeaderStyle-HorizontalAlign="Left"  />
   <asp:BoundField DataField="SQ_RFQ_DestinationCountry" HeaderText="Destination Country"   ItemStyle-Width="50px" DataFormatString="{0:dd/MM/yyyy}" HeaderStyle-Width="400px" HeaderStyle-HorizontalAlign="Left" />
    <asp:BoundField DataField="SQ_RFQ_OriginAirport" HeaderText="Origin Airport"   ItemStyle-Width="50px" HeaderStyle-Width="400px" HeaderStyle-HorizontalAlign="Left" />
    <asp:BoundField DataField="SQ_RFQ_DestinationAirport" HeaderText="Destination Airport"   ItemStyle-Width="50px" HeaderStyle-Width="400px" HeaderStyle-HorizontalAlign="Left" />
