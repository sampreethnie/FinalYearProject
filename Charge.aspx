<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Charge.aspx.cs" Inherits="FinalYearProject.Charge" %>
...
<body>
  ...
  <div class="col-xs-12" style="padding: 10px 70px 10px 50px; background-color:SteelBlue ">
                ...
                <ul class="dropdown-menu" role="menu" style="padding:0px; margin:0px; border-radius:0px;">
                  ...
                  <%--  <li><a href="GeneralMasters/AttributesList.aspx" target="fd_iframe">Attributes</a></li>--%>
                    ...
                    <li><a href="Currency.aspx">Currency</a></li>
                     <li><a href="Charge.aspx">Charge</a></li>
                </ul>
            </div>
                             <div class="btn-group" style="vertical-align:bottom;">
    ...
    <p class="navbar-text" style="font-size:21px">Charge</p>
...
<span class="input-group-addon nbrd" style="padding:0px 4px">
 ...
 <span class="input-group-addon nbrd" style="padding:0px 4px">
     ...
     <asp:GridView ID ="gvCharge" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="table-ui table-hover" DataKeyNames="M_Charge_Code" EmptyDataText="No record found!"
            ...
            <AlternatingRowStyle BackColor="White" />
             <Columns>
                <asp:BoundField HeaderText="ID" DataField="M_Charge_Code" Visible="false" />
                 <asp:BoundField HeaderText="Name" DataField="M_Charge_Name" />
                 <asp:BoundField HeaderText="ShortName" DataField="M_Charge_Sname" />
        ...
        <div id="pn1AddPopup" runat="server" style="width:500px; height:220px; background-color:#FFFFFF; border:3px solid#0DA9D0;border-radius:12px;padding:0">
             <div id="popupheader" class="popupHeader" style="background-color:orange;height:30px;color:white;line-height:30px;text-align:left;font-weight:bold;border-top-left-radius:6px;border-top-right-radius:6px">
                 <asp:Label ID="lblHeader" runat="server" Text="Add Charge" style="font-size:26px;padding:10px;font-style:inherit;font-family:Tahoma" />
                 <span style="float:right">
                    <img id="imgClose" src="/images/close3.png" alt="close1" title="Close1" />
                 </span>
             </div>
             <div>
            <asp:HiddenField ID="chargeidAddpopup" runat="server" Value="0" />
            <table border="0" class="table-border" style="min-height:50px;line-height:30px;text-align:left;font-weight:normal;font-size:17px">
                <tr>
                    ...
                    <td>Name</td>
                    <td><asp:TextBox ID="txtchargenameAddpopup" runat="server"  /> 
                        </td>
                    <td>
                      <asp:RequiredFieldValidator ID="charnameAddpopup" ControlToValidate="txtchargenameAddpopup"  ValidationGroup="addpopup"  SetFocusOnError="true" EnableClientScript="true" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>     
                    </td>
                ...
                <tr>
                    <td>ShortName</td>
                    <td><asp:TextBox ID="txtchargeshortnameAddpopup" runat="server" />
                        </td>
                    <td>
                         <asp:RequiredFieldValidator ID="charsnameAddpopup" ControlToValidate="txtchargeshortnameAddpopup" ValidationGroup="addpopup"  SetFocusOnError="true" EnableClientScript="true" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                       </td>
        ...
        <div id="pn1EditPopup" runat="server" style="width:500px; height:220px; background-color:#FFFFFF; border:3px solid#0DA9D0;border-radius:12px;padding:0">
             <div id="popupheader1" class="popupHeader1" style="background-color:orange;height:30px;color:white;line-height:30px;text-align:left;font-weight:bold;border-top-left-radius:6px;border-top-right-radius:6px">
                 <asp:Label ID="Label2" runat="server" Text="Edit Charge" style="font-size:26px;padding:10px;font-style:inherit;font-family:Tahoma" />
                 <span style="float:right">
                    <img id="imgClose1" src="/images/close3.png" alt="close" title="Close" />
                 </span>
             </div>
        <div>
            <asp:HiddenField ID="chargeidEditpopup" runat="server" Value="0"  />
            <table border="0" class="table-border" style="min-height:50px;line-height:30px;text-align:left;font-weight:normal;font-size:17px">
                <tr>
                    <td>Name</td>
                    <td><asp:TextBox ID="txtchargenameEditpopup" runat="server" /></td>
                    <td> 
                        <asp:RequiredFieldValidator ID="charnameEditpopup" ControlToValidate="txtchargenameEditpopup" ValidationGroup="editpopup" SetFocusOnError="true" EnableClientScript="true" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>ShortName</td>
                    <td><asp:TextBox ID="txtchargeshortnameEditpopup" runat="server" /></td>
                    <td>
                        <asp:RequiredFieldValidator ID="charsnameEditpopup" ControlToValidate="txtchargeshortnameEditpopup" ValidationGroup="editpopup" SetFocusOnError="true" EnableClientScript="true" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                <td>
        ...
        <div id="pn1ViewPopup" runat="server" style="width:550px;height:200px; background-color:#FFFFFF;border:3px solid#0DA9D0;border-radius:12px;padding:0">
            <div id="popupheader2" class="popupHeader2" style="background-color:orange;height:30px;color:white;line-height:30px;text-align:left;font-weight:bold;border-top-left-radius:6px;border-top-right-radius:6px" >
                <asp:Label ID="Label1" runat="server" Text="View Charge" style="font-size:26px;padding:10px;font-style:inherit;font-family:Tahoma" />
                <span style="float:right">
            ...
            <div>
                <asp:HiddenField ID="chargeidViewpopup" runat="server" Value="0"  />
                <table border="0" class="table-border" style="min-height:50px;line-height:30px;text-align:left;font-weight:normal;font-size:17px">
                    <tr>
                        <td>Name</td>
                        
                        <td><asp:TextBox ID="viewchargename" runat="server" ReadOnly="true" /></td>
                     ...
                     <tr>
                        ...
                        <td><asp:TextBox ID="viewchargeshortname" runat="server" ReadOnly="true"/></td>
         ...
         <ajaxToolkit:ModalPopupExtender ID="mpeChargeAddpopup" runat="server" TargetControlID="chargeidAddpopup"
            PopupControlID="pn1AddPopup" BehaviorID="mpeChargeBehaviourAddpopup" DropShadow="true"
            CancelControlID="imgClose" PopupDragHandleControlID="popupheader" BackgroundCssClass="modalBackground"  />
             <ajaxToolkit:ModalPopupExtender ID="mpeChargeEditpopup" runat="server" TargetControlID="chargeidAddpopup"
            PopupControlID="pn1EditPopup" BehaviorID="mpeChargeBehaviourEditpopup" DropShadow="true"
            CancelControlID="imgClose1" PopupDragHandleControlID="popupheader1" BackgroundCssClass="modalBackground" />
        <ajaxToolkit:ModalPopupExtender ID="mpeChargeViewpopup" runat="server" TargetControlID="chargeidAddpopup"
            PopupControlID="pn1ViewPopup" BehaviorID="mpeChargeBehaviourViewpopup" DropShadow="true"
