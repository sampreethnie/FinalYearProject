<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Carrier.aspx.cs" Inherits="FinalYearProject.Carrier" %>
...
<body>
  ...
  <div class="col-xs-12" style="padding: 10px 70px 10px 50px; background-color:SteelBlue ">
    ...
    <p class="navbar-text" style="font-size:21px">Carrier</p>
...
<span class="input-group-addon nbrd" style="padding:0px 4px">
 ...
 <span class="input-group-addon nbrd" style="padding:0px 4px">
     ...
     <asp:GridView ID ="gvCarrier" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="table-ui table-hover" DataKeyNames="M_Carrier_Slno" EmptyDataText="No record found!"
            ...
            <AlternatingRowStyle BackColor="White" />
             <Columns>
                <asp:BoundField HeaderText="ID" DataField="M_Carrier_Slno" Visible="false" />
                 <asp:BoundField HeaderText="Name" DataField="M_Carrier_Name" />
                 <asp:BoundField HeaderText="ShortName" DataField="M_Carrier_Sname" />
        ...
        <div id="pn1AddPopup" runat="server" style="width:500px; height:220px; background-color:#FFFFFF; border:3px solid#0DA9D0;border-radius:12px;padding:0">
             <div id="popupheader" class="popupHeader" style="background-color:orange;height:30px;color:white;line-height:30px;text-align:left;font-weight:bold;border-top-left-radius:6px;border-top-right-radius:6px">
                 <asp:Label ID="lblHeader" runat="server" Text="Add Carrier" style="font-size:26px;padding:10px;font-style:inherit;font-family:Tahoma" />
                 <span style="float:right">
                    <img id="imgClose" src="/images/close3.png" alt="close1" title="Close1" />
                 </span>
             </div>
             <div>
            <asp:HiddenField ID="carrieridAddpopup" runat="server" Value="0" />
            <table border="0" class="table-border" style="min-height:50px;line-height:30px;text-align:left;font-weight:normal;font-size:17px">
                <tr>
                    ...
                    <td>Name</td>
                    <td><asp:TextBox ID="txtcarriernameAddpopup" runat="server"  /> 
                        </td>
                    <td>
                      <asp:RequiredFieldValidator ID="carrrnameAddpopup" ControlToValidate="txtcarriernameAddpopup"  ValidationGroup="addpopup"  SetFocusOnError="true" EnableClientScript="true" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>     
                    </td>
                ...
                <tr>
                    <td>ShortName</td>
                    <td><asp:TextBox ID="txtcarriershortnameAddpopup" runat="server" />
                        </td>
                    <td>
                         <asp:RequiredFieldValidator ID="carrsnameAddpopup" ControlToValidate="txtcarriershortnameAddpopup" ValidationGroup="addpopup"  SetFocusOnError="true" EnableClientScript="true" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                       </td>
                ...
                <td>
                    ...
                    &nbsp; &nbsp; &nbsp;
                    <asp:Button ID="btnCancelAddpopup" runat="server" Text="Cancel" style="background-color:#9F9F9F;border:1px solid #5C5C5C" OnClientClick="javascript:$find('mpeCarrierBehaviourAddpopup').hide();return false;" />
        ...
        <div id="pn1EditPopup" runat="server" style="width:500px; height:220px; background-color:#FFFFFF; border:3px solid#0DA9D0;border-radius:12px;padding:0">
             <div id="popupheader1" class="popupHeader1" style="background-color:orange;height:30px;color:white;line-height:30px;text-align:left;font-weight:bold;border-top-left-radius:6px;border-top-right-radius:6px">
                 <asp:Label ID="Label2" runat="server" Text="Edit Carrier" style="font-size:26px;padding:10px;font-style:inherit;font-family:Tahoma" />
                 <span style="float:right">
                    <img id="imgClose1" src="/images/close3.png" alt="close" title="Close" />
                 </span>
             </div>
        <div>
            <asp:HiddenField ID="carrieridEditpopup" runat="server" Value="0"  />
            <table border="0" class="table-border" style="min-height:50px;line-height:30px;text-align:left;font-weight:normal;font-size:17px">
                <tr>
                    <td>Name</td>
                    <td><asp:TextBox ID="txtcarriernameEditpopup" runat="server" /></td>
                    <td> 
                        <asp:RequiredFieldValidator ID="carrnameEditpopup" ControlToValidate="txtcarriernameEditpopup" ValidationGroup="editpopup" SetFocusOnError="true" EnableClientScript="true" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>ShortName</td>
                    <td><asp:TextBox ID="txtcarriershortnameEditpopup" runat="server" /></td>
                    <td>
                        <asp:RequiredFieldValidator ID="carrsnameEditpopup" ControlToValidate="txtcarriershortnameEditpopup" ValidationGroup="editpopup" SetFocusOnError="true" EnableClientScript="true" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                <td>
                ...
                <td>
                    ...
                    &nbsp; &nbsp; &nbsp;
                    <asp:Button ID="btnCancelEditpopup" runat="server" Text="Cancel" style="background-color:#9F9F9F;border:1px solid #5C5C5C" OnClientClick="javascript:$find('mpeCarrierBehaviourEditpopup').hide();return false;" />
        ...
        <div id="pn1ViewPopup" runat="server" style="width:550px;height:200px; background-color:#FFFFFF;border:3px solid#0DA9D0;border-radius:12px;padding:0">
            <div id="popupheader2" class="popupHeader2" style="background-color:orange;height:30px;color:white;line-height:30px;text-align:left;font-weight:bold;border-top-left-radius:6px;border-top-right-radius:6px" >
                <asp:Label ID="Label1" runat="server" Text="View Carrier" style="font-size:26px;padding:10px;font-style:inherit;font-family:Tahoma" />
                <span style="float:right">
            ...
            <div>
                <asp:HiddenField ID="carrieridViewpopup" runat="server" Value="0"  />
                <table border="0" class="table-border" style="min-height:50px;line-height:30px;text-align:left;font-weight:normal;font-size:17px">
                    <tr>
                        <td>Name</td>
                        
                        <td><asp:TextBox ID="viewcarriername" runat="server" ReadOnly="true" /></td>
                     ...
                     <tr>
                        ...
                        <td><asp:TextBox ID="viewcarriershortname" runat="server" ReadOnly="true"/></td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnCancel2" runat="server" Text="Cancel" style="background-color:#2FBDF1;border:1px solid #5C5C5C" OnClientClick="javascript:$find('mpeCarrierBehaviourViewpopup').hide();return false;" />
                        </td>
                    </tr>
         ...
         <ajaxToolkit:ModalPopupExtender ID="mpeCarrierAddpopup" runat="server" TargetControlID="carrieridAddpopup"
            PopupControlID="pn1AddPopup" BehaviorID="mpeCarrierBehaviourAddpopup" DropShadow="true"
            CancelControlID="imgClose" PopupDragHandleControlID="popupheader" BackgroundCssClass="modalBackground"  />
             <ajaxToolkit:ModalPopupExtender ID="mpeCarrierEditpopup" runat="server" TargetControlID="carrieridAddpopup"
            PopupControlID="pn1EditPopup" BehaviorID="mpeCarrierBehaviourEditpopup" DropShadow="true"
            CancelControlID="imgClose1" PopupDragHandleControlID="popupheader1" BackgroundCssClass="modalBackground" />
        <ajaxToolkit:ModalPopupExtender ID="mpeCarrierViewpopup" runat="server" TargetControlID="carrieridAddpopup"
            PopupControlID="pn1ViewPopup" BehaviorID="mpeCarrierBehaviourViewpopup" DropShadow="true"
