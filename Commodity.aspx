<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Commodity.aspx.cs" Inherits="FinalYearProject.Commodity" %>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <li>
        ...
        <a ><asp:Label ID="lblusername" style="width:30px;font-family:'Times New Roman'" runat="server"/></a>
            </div>
        <br />
        <div style="text-align:left">
        <a><asp:Label ID="lblcompanyname" style="width:30px;font-family:'Times New Roman'" runat="server"></asp:Label></a>
            </div>
        <br />
  ...
  <ul class="dropdown-menu" role="menu">
    ...
    <p class="navbar-text" style="font-size:21px">Commodity</p>
...
<span class="input-group-addon nbrd" style="padding:0px 4px">
 ...
 <span class="input-group-addon nbrd" style="padding:0px 4px">
        ...
        <asp:GridView ID="gvCommodity" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="table-ui table-hover" DataKeyNames="M_Commodity_Slno" EmptyDataText="No record found!"
            ...
            <Columns>
                <asp:BoundField HeaderText="ID" DataField="M_Commodity_Code" Visible="false" />
                 <asp:BoundField HeaderText="Name" DataField="M_Commodity_Name" />
                 <asp:BoundField HeaderText="ShortName" DataField="M_Commodity_Sname" />
...
<EmptyDataRowStyle CssClass="gvEmpty"></EmptyDataRowStyle>
        ...
        <div id="pn1AddPopup" runat="server" style="width:500px; height:220px; background-color:#FFFFFF; border:3px solid#0DA9D0;border-radius:12px;padding:0">
             <div id="popupheader" class="popupHeader" style="background-color:orange;height:30px;color:white;line-height:30px;text-align:left;font-weight:bold;border-top-left-radius:6px;border-top-right-radius:6px">
                 <asp:Label ID="lblHeader" runat="server" Text="Add Commodity" style="font-size:26px;padding:10px;font-style:inherit;font-family:Tahoma" />
                 <span style="float:right">
                    <img id="imgClose" src="/images/close3.png" alt="close1" title="Close1" />
                 </span>
             </div>
        <div>
            <asp:HiddenField ID="commodityid" runat="server" Value="0" />
            <table border="0" class="table-border" style="min-height:50px;line-height:30px;text-align:left;font-weight:normal;font-size:17px">
                <tr>
                    ...
                    <td>Name</td>
                    <td><asp:TextBox ID="txtcommodityname" runat="server"  /> 
                        </td>
                    <td>
                      <asp:RequiredFieldValidator ID="commodityname" ControlToValidate="txtcommodityname"  ValidationGroup="addpopup"  SetFocusOnError="true" EnableClientScript="true" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>     
                    </td>
                ...
                <tr>
                    <td>ShortName</td>
                    <td><asp:TextBox ID="txtcommodityshortname" runat="server" />
                        </td>
                    <td>
                         <asp:RequiredFieldValidator ID="commoditysname" ControlToValidate="txtcommodityshortname" ValidationGroup="addpopup"  SetFocusOnError="true" EnableClientScript="true" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                       </td>
                ...
                <td>
                     <asp:Button ID="btnSave" runat="server" Text=" Save " CausesValidation="true" ValidationGroup="addpopup" style="background-color:#2FBDF1;border:1px solid #0DA9D0"
                          OnClick="btnSave_Click" />
                    &nbsp; &nbsp; &nbsp;
                    <asp:Button ID="btnCancel" runat="server" Text="Cancel" style="background-color:#9F9F9F;border:1px solid #5C5C5C" OnClientClick="javascript:$find('mpeUserBehaviour').hide();return false;" />
            ...
            <div id="pn1EditPopup" runat="server" style="width:500px; height:220px; background-color:#FFFFFF; border:3px solid#0DA9D0;border-radius:12px;padding:0">
             <div id="popupheader1" class="popupHeader1" style="background-color:orange;height:30px;color:white;line-height:30px;text-align:left;font-weight:bold;border-top-left-radius:6px;border-top-right-radius:6px">
                 <asp:Label ID="lbleditcommodity" runat="server" Text="Edit Commodity" style="font-size:26px;padding:10px;font-style:inherit;font-family:Tahoma" />
                 <span style="float:right">
                    <img id="imgClose1" src="/images/close3.png" alt="close" title="Close" />
                 </span>
             </div>
        <div>
            <asp:HiddenField ID="commodityid1" runat="server" Value="0"  />
            <table border="0" class="table-border" style="min-height:50px;line-height:30px;text-align:left;font-weight:normal;font-size:17px">
                <tr>
                    <td>Name</td>
                    <td><asp:TextBox ID="txtcommodityname1" runat="server" /></td>
                    <td> 
                        <asp:RequiredFieldValidator ID="commoditynameEditpopup" ControlToValidate="txtcommodityname1" ValidationGroup="editpopup" SetFocusOnError="true" EnableClientScript="true" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>ShortName</td>
                    <td><asp:TextBox ID="txtcommodityshortname1" runat="server" /></td>
                    <td> 
                        <asp:RequiredFieldValidator ID="commoditysnameEditpopup" ControlToValidate="txtcommodityname1" ValidationGroup="editpopup" SetFocusOnError="true" EnableClientScript="true" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                <td>
                ...
                <td>
                     <asp:Button ID="btnSave1" runat="server" CssClass="form-control" Text="Save" CausesValidation="true" ValidationGroup="editpopup" style="background-color:#2FBDF1;border:1px solid #0DA9D0"
                          OnClick="btnSave_Click1" />
                    &nbsp; &nbsp; &nbsp;
                    <asp:Button ID="btnCancel1" runat="server" Text="Cancel" style="background-color:#9F9F9F;border:1px solid #5C5C5C" OnClientClick="javascript:$find('mpeUserBehaviour1').hide();return false;" />
        ...
        <div id="pn1ViewPopup" runat="server" style="width:550px;height:200px; background-color:#FFFFFF;border:3px solid#0DA9D0;border-radius:12px;padding:0">
            <div id="popupheader2" class="popupHeader2" style="background-color:orange;height:30px;color:white;line-height:30px;text-align:left;font-weight:bold;border-top-left-radius:6px;border-top-right-radius:6px" >
                <asp:Label ID="lblviewcommodity" runat="server" Text="View Commodity" style="font-size:26px;padding:10px;font-style:inherit;font-family:Tahoma" />
                <span style="float:right">
            ...
            <div>
                <asp:HiddenField ID="commodityid2" runat="server" Value="0"  />
                <table border="0" class="table-border" style="min-height:50px;line-height:30px;text-align:left;font-weight:normal;font-size:17px">
                    <tr>
                        <td>Name</td>
                        
                        <td><asp:TextBox ID="viewcommodityname" runat="server" ReadOnly="true" /></td>
                     ...
                     <tr>
                        ...
                        <td><asp:TextBox ID="viewcommodityshortname" runat="server" ReadOnly="true"/></td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnCancel2" runat="server" Text="Cancel" style="background-color:#2FBDF1;border:1px solid #5C5C5C" OnClientClick="javascript:$find('mpeUserBehaviour2').hide();return false;" />
                        </td>
                    </tr>
        ...
        <ajaxToolkit:ModalPopupExtender ID="mpeCommodity" runat="server" TargetControlID="commodityid"
            PopupControlID="pn1AddPopup" BehaviorID="mpeUserBehaviour" DropShadow="true"
            CancelControlID="imgClose" PopupDragHandleControlID="popupheader" BackgroundCssClass="modalBackground"  />
             <ajaxToolkit:ModalPopupExtender ID="mpeCommodity1" runat="server" TargetControlID="commodityid"
            PopupControlID="pn1EditPopup" BehaviorID="mpeUserBehaviour1" DropShadow="true"
            CancelControlID="imgClose1" PopupDragHandleControlID="popupheader1" BackgroundCssClass="modalBackground" />
        <ajaxToolkit:ModalPopupExtender ID="mpeCommodity2" runat="server" TargetControlID="commodityid"
            PopupControlID="pn1ViewPopup" BehaviorID="mpeUserBehaviour2" DropShadow="true"
